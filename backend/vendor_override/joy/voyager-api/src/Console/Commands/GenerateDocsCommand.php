...
class GenerateDocsCommand extends Command
{
    ...
    protected function resourcePaths(
        ...
        $slugExclude = ['users'=>'users', 'menus'=>'menus', 'roles'=>'roles', 'posts'=>'posts', 'pages'=>'pages', 'configurations'=>'configurations'];
        $onlyIndex = ['sellers' => 'sellers', 'product-types' => 'product-types', 'labours' => 'labours',
                        'products' => 'products', 'space-types' => 'space-types', 'geo-infos' => 'geo-infos',
                        'product-categories' => 'product-categories', 'types' => 'types',
                        'colors' => 'colors', 'openings' => 'openings', 'frame-materials' => 'frame-materials',
                        'iva' => 'iva', 'categories'=>'categories', 'doors' => 'doors', 'windows' => 'windows',
                        'blinds' => 'blinds', 'floors' => 'floors', 'ceilings' => 'ceilings', 'electrical-mechanisms' => 'electrical-mechanisms'
                    ];

        if(!array_key_exists($dataType->slug, $slugExclude)){
            if(!array_key_exists($dataType->slug, $onlyIndex)){
